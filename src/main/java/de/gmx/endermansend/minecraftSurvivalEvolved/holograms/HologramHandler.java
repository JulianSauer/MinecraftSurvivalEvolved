package de.gmx.endermansend.minecraftSurvivalEvolved.holograms;
...
public class HologramHandler {
            ...
            for (; i < textLength; i++) {
                try {
                    ...
                    armorStands.add((ArmorStand)
                            Bukkit.getScheduler().callSyncMethod(de.gmx.endermansend.minecraftSurvivalEvolved.main.Plugin.getInstance(),
    ...
    /**
     * Removes all holograms from all worlds.
     */
