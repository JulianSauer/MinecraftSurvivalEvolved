...
public enum ChatMessages implements Messages {
    ...
    HELP_TRIBE1(Format.HELP_TITLE + "Usage:" + Format.HELP_TEXT + " /mse tribe <create | leave | <tribe name> | promote | demote>."),
    ...
    HELP_TRIBE_INVITE1(Format.HELP_TITLE + "Usage:" + Format.HELP_TEXT + " /mse tribe invite <player name>."),
    HELP_TRIBE_INVITE2(Format.HELP_TITLE + "Description:" + Format.HELP_TEXT + " Can be used to invite a player to your tribe."),
    HELP_TRIBE_PROMOTE1(Format.HELP_TITLE + "Usage:" + Format.HELP_TEXT + " /mse tribe promote <player name>"),
    HELP_TRIBE_PROMOTE2(Format.HELP_TITLE + "Description" + Format.HELP_TEXT + " Can be used to promote another member"),
    HELP_TRIBE_DEMOTE1(Format.HELP_TITLE + "Usage:" + Format.HELP_TEXT + " /mse tribe demote <player name>"),
