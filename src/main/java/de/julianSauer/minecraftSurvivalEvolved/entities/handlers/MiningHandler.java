...
public class MiningHandler {
    ...
    private final Map<Material, Integer> mineableBlocks;
    ...
    public long calculateMiningTimeFor(Material material) {
        ...
        double damage = mseEntity.getTameableEntityAttributes().getDamage();
        double maxDamage = mseEntity.getTameableEntityAttributes().getMaxDamage() * 2;
