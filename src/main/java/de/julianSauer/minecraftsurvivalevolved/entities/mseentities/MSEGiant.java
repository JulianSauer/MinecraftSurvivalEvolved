...
public class MSEGiant extends EntityGiantZombie implements MSEEntity, Rideable {

    private TameableAttributesContainer<MSEGiant> tameableAttributesContainer;

    private TamingHandler<MSEGiant> tamingHandler;
