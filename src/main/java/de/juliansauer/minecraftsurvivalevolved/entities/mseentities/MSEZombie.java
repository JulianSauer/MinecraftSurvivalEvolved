...
public class MSEZombie extends EntityZombie implements MSEEntity {

    private TameableAttributesContainer<MSEZombie> tameableAttributesContainer;

    private TamingHandler<MSEZombie> tamingHandler;
