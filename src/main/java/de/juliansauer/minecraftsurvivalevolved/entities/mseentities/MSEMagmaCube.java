...
public class MSEMagmaCube extends EntityMagmaCube implements MSEEntity {
    ...
    private TamingHandler<MSEMagmaCube> tamingHandler;
    ...
    public MSEMagmaCube(World world) {
        super(world);
        entityType = getName();
    ...
    public PathfinderGoal getMeleeAttack() {
        Constructor constructor = ReflectionHelper.getConstructor(EntitySlime.class, "PathfinderGoalSlimeRandomJump", EntitySlime.class);
        try {
            if (constructor != null)
    ...
    public void playAttackSound() {
        playAttackSound(Sound.ENTITY_MAGMACUBE_SQUISH);
    }
